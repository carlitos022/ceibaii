...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="absolute top-0 left-0 right-0 h-14 bg-[#000f20]/85 backdrop-blur-md border-b border-[#293a50]/50 flex items-center justify-between px-4 z-30 select-none">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex items-center space-x-2">
          <span className="text-xl font-bold text-[#00d1ff] tracking-wide drop-shadow-[0_0_8px_rgba(0,209,255,0.4)]">
            CustomServiciosRS
          </span>
