...
export const BottomNavBar: React.FC<BottomNavBarProps> = ({
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 h-16 bg-[#000f20]/95 backdrop-blur-xl border-t border-[#293a50] grid grid-cols-6 items-center px-1 z-40 select-none shadow-[0_-8px_24px_rgba(0,0,0,0.45)]"
      style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}
    >
      {/* Tab: Vivo */}
      <button
        onClick={() => onTabChange('vivo')}
        className={`flex flex-col items-center justify-center gap-1 p-1.5 relative transition-colors cursor-pointer ${
